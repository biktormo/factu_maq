...
export default function AnalisisVendedor() {
    ...
    // --- CORRECCIÓN AQUÍ: LÓGICA DE useMemo SEPARADA ---

    // Memo #1: Calcula las listas de opciones para los filtros.
    ...
    // Memo #2: Filtra las ventas por año.
    ...
    // Memo #3: Genera y ordena el ranking.
    ...
    // Memo #4: Filtra las ventas para el vendedor individual.
    ...
    // Memo #5: Calcula los KPIs para el vendedor individual.
    ...
    return (
        <main className="container">
            {/* El JSX del return no cambia, así que lo puedes dejar como estaba */}
            {/* ... */}
        </main>
    );
}

// Para estar 100% seguros, aquí está el return completo también.
// ... (código anterior)
